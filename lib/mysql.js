...
// blogs
const insertBlog = function ({ title='', content='', images='', uid, forward_comment='', source_id=null }) {
...
module.exports = {
    query, findUserByName, insertUser, updateUserBio,/* users操作 */
    insertBlog, findBlogById, findAllBlogs, deleteBlog, unpdateBlogForwards, unpdateBlogComments,/* blogs操作 */
    insertComment, findAllBlogComments, deleteComment, clearBlogComments,/* comments操作 */
